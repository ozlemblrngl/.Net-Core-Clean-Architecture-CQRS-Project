...
{
    // burada queryleri linqe çevirmek üzere kodlar yazıyoruz system.linq.dynamic.core un istediği yapıya uygun olarak çevirecek şekilde.
    // keza system.linq.dynamic.core string şeklinde istiyor yapıyı sonra onu linq e çeviriyor. 
    // buradaki çoğu kod system... kütüphanesinin standartlarına uyarak hazılanmış. O nedenle anlamak için system.linq.dynamic.core un çalışma prensibini incelemek lazım.
